...
public class Game_command {
    ...
    public static void put_equipment(Equipment equipment, int position, Player commander, Fightground Arena){
        ...
        if(fight_area[position - 1] == null){
            System.out.println("command failed, this position is null\n");
        }
        else if(fight_area[position - 1].get_equipment() != null){
            System.out.println("command failed, this unit has equipped " + fight_area[position - 1].get_equipment() + "\n");
        }
        else{
            fight_area[position - 1].put_on_equipment(equipment);
            commander.get_hand_area_equipments().remove(equipment);
            System.out.println("command success, equipment "+ fight_area[position - 1].get_equipment() + " is put on\n");
        }        
    }

    //put function for potions
    public static void put_potion(Potion potion, int position, Player commander, Fightground Arena){
        ...
        if(fight_area[position - 1] == null){
            ...
            System.out.println("command failed, this unit has consumed " + fight_area[position - 1].get_potion() + " potion\n");
        }
        else{
    ...
    //determine the String is equipment
    ...
    //return commander's wanted equipment
    ...
    //determine the String is potion
    ...
    //return commander's wanted potion
