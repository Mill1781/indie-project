...
public class Updator {
    ...
    public static void download_Player_data(String file_txt, Player P1, Player P2, Fightground Arena){
        ...
        try{
            ...
            for(int i = 0; i < 2; i++){
                ...
                for(int k = 0; k < 6; k++){
                    card_amount[k] = player_data.next();//each card's amount
                }

                for(int k = 0; k < 6; k++){
                    equipment_amount[k] = Integer.parseInt(player_data.next());//each equipment's amount
                }

                for(int k = 0; k < 3; k++){
                    potion_amount[k] = Integer.parseInt(player_data.next());//each potion's amount
                }
    ...
    public static void download_Fightground_data(String file_txt, Fightground arena){
        ...
        try{
            ...
            fightground_data.next();//skip the first number --> 1 of P1
            for(int i = 0; i < 3; i++){
            ...
            //P2's part
            fightground_data.next();//skip first number --> 1
            for(int i = 0; i < 3; i++){
                card_class = fightground_data.next();
                if(card_class.equals("none")){
                    ...
                    try{
                        ...
                        // when i = 2, temp must eat next token to determine whether any equipment or potion existing. Exception occurs when both of them do not exist 
                    }catch(Exception e){
    ...
    //changing the int equipment amount data into object form and push in Player's hand_area
    ...
    //changing the equipment object in player's hand_area into int array form
    ...
    //changing the int potion amount data into object form and push in Player's hand_area
    ...
    //locating desired equipment's name and return corresponding object
    ...
    //locating desired potion's name and return corresponding object
