...
public class Card {
    ...
    private int defense;//card's defense
    private Equipment equipment;//card's equipment
    private Potion potion;//card consumed potion
    ...
    public static void summon(String card_class, int position, Player player, Fightground Arena){
        //hand_area[0]-->priest, [1]-->tank, [2]-->shooter, [3]-->assassin, [4]-->businessman, [5]-->bomber
        int card_pp_consume;
        int card_amount;
        ...
        int summon_card_id;//[0]-->priest, [1]-->tank, [2]-->shooter, [3]-->assassin, [4]-->businessman, [5]-->bomber
        ...
        else if(card_class.equals("bomber")){
    ...
    //potion consume function from saving
    public void comsume_potion_from_save(Potion p){
        potion = p;
    }

    //cancel the effect of potion after a turn
    ...
    //return card's max life
    public int get_Max_life(){
        return Max_life;
    }

    //return card's defense
    ...
    //return card's equipment
    public Equipment get_equipment(){
        return equipment;
    }
    
    //return card's consumed potion
